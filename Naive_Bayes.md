Naive Baye's Classification (Non - Linear)
================
...
``` r
## Fitting Naive Bayes classifier to the Training set and Predict the test set result
...
``` r
 ...
 # Our model predicted 86 correct and 14  wrong predictions. Total records are 100.
...
![](Naive_Bayes_files/figure-markdown_github/unnamed-chunk-4-1.png)
